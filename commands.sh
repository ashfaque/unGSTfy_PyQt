...
export py2direxe=$(echo -e 'pyinstaller --noconfirm --onedir --windowed --clean --name "unGSTfy" --icon "assets/icons/gst_logo.ico" --log-level "INFO" --add-data "assets;assets/" main.py')
export py2debugexe=$(echo -e 'pyinstaller --noconfirm --onedir --console --clean --name "unGSTfy" --icon "assets/icons/gst_logo.ico" --log-level "INFO" --add-data "assets;assets/"  main.py')
