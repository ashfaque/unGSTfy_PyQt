...
# [TODO] Using QThread run something in background without freezing the GUI.

# [TODO] Start on Boot (Windows, macOS, Linux)

# [TODO] If multiple instances are launched for this application, then bring the already running application in the foreground.
