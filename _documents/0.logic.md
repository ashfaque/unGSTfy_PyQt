...
# [TODO] Using QThread run something in background without freezing the GUI. [4.Run_in_bg_without_freezing_gui](4.Run_in_bg_without_freezing_gui.md)

# [TODO] Start on Boot (Windows, macOS, Linux)

# [TODO] Converting Py to executable installable (Windows, macOS, Linux)
- Have a look at [1.Installer](1.Installer.md) & [2.Distributing_Installer](2.Distributing_Installer.md)
